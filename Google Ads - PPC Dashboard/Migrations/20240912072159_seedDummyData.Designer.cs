...
namespace Google_Ads___PPC_Dashboard.Migrations
{
    ...
    [Migration("20240912072159_seedDummyData")]
            ...
            modelBuilder.Entity("Google_Ads___PPC_Dashboard.Models.Ad", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdGroupId = 1,
                            AdType = "Text",
                            CreatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1503),
                            ...
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1505)
                        },
                        new
                        {
                            Id = 2,
                            AdGroupId = 2,
                            AdType = "Display",
                            CreatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1508),
                            ...
                            Status = "Paused",
                            UpdatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1509)
                        });
                });
            ...
            modelBuilder.Entity("Google_Ads___PPC_Dashboard.Models.AdGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampaignId = 1,
                            CreatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1469),
                            Name = "Discount Ads",
                            Status = "Enabled",
                            UpdatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1471)
                        },
                        new
                        {
                            Id = 2,
                            CampaignId = 2,
                            CreatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1473),
                            Name = "Holiday Ads",
                            Status = "Paused",
                            UpdatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1475)
                        });
                });
            ...
            modelBuilder.Entity("Google_Ads___PPC_Dashboard.Models.Campaign", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Budget = 5000m,
                            BudgetType = "Daily",
                            CreatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1344),
                            GoogleCampaignId = "GC001",
                            Name = "Summer Sale",
                            StartDate = new DateTime(2024, 8, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1289),
                            Status = "Active",
                            UpdatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1346)
                        },
                        new
                        {
                            Id = 2,
                            Budget = 3000m,
                            BudgetType = "Monthly",
                            CreatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1351),
                            GoogleCampaignId = "GC002",
                            Name = "Winter Sale",
                            StartDate = new DateTime(2024, 7, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1349),
                            Status = "Paused",
                            UpdatedAt = new DateTime(2024, 9, 12, 9, 21, 58, 622, DateTimeKind.Local).AddTicks(1352)
                        });
                });
